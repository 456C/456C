...
execute as @s[scores={item5=1, totalArrows = 8..}] at @s run tag @s add empoweredArcher
execute as @s[scores={item5=1, totalArrows = 8}] at @s run playsound block.bell.use master @s ~ ~ ~ 3 1
execute as @s[scores={item5=1, totalArrows = 9..}] at @s run tag @s remove empoweredArcher
execute as @s[scores={item5=1, totalArrows = 9..}] at @s run scoreboard players reset @s totalArrows

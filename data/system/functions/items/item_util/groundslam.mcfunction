...
execute as @s[tag=groundslam,scores={item10=1..24},nbt={OnGround:1b}] at @s as @e[tag=!groundslam,distance=..6,type=!player] run function system:effect/medium_damage 
